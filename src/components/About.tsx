  ...
  const values = [
    {
      ...
      description:
        "We&apos;re on a mission to make learning accessible, efficient, and enjoyable for everyone.",
    },
    {
      icon: <Lightbulb className="h-6 w-6" />,
      title: "Innovation First",
      description:
        "Constantly pushing the boundaries of what&apos;s possible with AI-powered education technology.",
    },
    {
    ...
    },
    {
      ...
      title: "Excellence",
      description:
        "Committed to delivering the highest quality learning experience through continuous improvement.",
    },
  ];
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            We believe that learning should be efficient, engaging, and
            accessible to everyone. That&apos;s why we created FlashFathom AI -
            to harness the power of artificial intelligence and make studying
        ...
        >
          <div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                FlashFathom AI was born from a simple observation: students
                spend countless hours creating flashcards manually, when they
                could be focusing on actually learning the material.
              </p>
              <p>
                Our founder, frustrated with the time-consuming process of
                creating study materials, envisioned a world where AI could
                instantly transform any content into effective learning tools.
              </p>
              <p>
                Today, FlashFathom AI serves over 35,000 students and
                professionals worldwide, helping them learn faster and retain
                information better through intelligent, AI-generated flashcards.
              </p>
            </div>
          </div>
